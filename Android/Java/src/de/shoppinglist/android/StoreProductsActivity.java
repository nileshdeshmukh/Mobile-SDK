...
import com.surveyanalytics.androidsdk.TakeSurvey;
import com.surveyanalytics.androidsdk.Utilities.Constants;
...
public class StoreProductsActivity extends AbstractShoppinglistActivity {
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case R.id.actionbarOptions:
			...
			break;
		case R.id.actionbarGiveFeedback:
			//Toast.makeText(context, "Loading questionaires...", Toast.LENGTH_SHORT).show();
			Intent intent1=new Intent(this,TakeSurvey.class);
			intent1.putExtra(Constants.PANEL_API_KEY,"44951020-2c74-4a76-9600-52a455421918");
			intent1.putExtra(Constants.PANEL_MEMBER_ID, "2103853");
			intent1.putExtra(Constants.SURVEY_ID, "3145394");
